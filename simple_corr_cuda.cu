...
void __global__ kernel0(double * xpos,double * ypos,double * zpos,int64_t * npairs,double * rpavg,double * rupp,int64_t Npart,const double sqr_rmin,const double sqr_rmax,int logbins,const double log10rmin,const double inv_dlogr,int nbins, int device_M , int device_N, int64_t* totalNpairs,double* totalRpavg){
